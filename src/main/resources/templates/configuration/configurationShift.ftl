                                                ...
                                                <div layout-gt-xs="row" style="margin-right: 10px;">
                                                    <div flex-gt-xs>
                                                        ...
                                                        <span class="alert alert-danger error"
                                                              ng-show="shiftForm.openTime.$dirty && shiftForm.openTime.$error.required">Rantre yon lè ouvèti!</span>
                                                        <span class="alert alert-danger error"
                                                              ng-show="shiftForm.openTime.$dirty && shiftForm.openTime.$error.time">Lè sa pa bon!</span>
                                                    </div>
                                                    ...
                                                    <div flex-gt-xs>
                                                        ...
                                                        <span class="alert alert-danger error" role="alert"
                                                              ng-show="shiftForm.closeTime.$dirty && shiftForm.closeTime.$error.required">Rantre yon lè femèti!</span>
                                                        <span class="alert alert-danger error" role="alert"
                                                              ng-show="shiftForm.closeTime.$dirty && shiftForm.closeTime.$error.time">Lè sa pa bon!</span>
                                                    </div>
                                                </div>
                                            </md-card-content>

                                            <md-card-actions layout="row" layout-align="end center">
                                                <md-button ng-disabled="shiftForm.$invalid" ng-click="saveShift()"
