          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <form class="form-horizontal" id="drawForm" action="/draw/create" th:object="${draw}" method="post">
                ...
                <div class="form-group">
                  <label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12" for="numberThreeDigits">Loto 3 chif
                ...
                <div class="form-group">
                  <label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12" for="firstDraw">Bòlet <span
                            class="required">*</span></label>
