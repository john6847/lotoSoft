          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <form name="sellerForm" id="sellerForm" class="form-horizontal" action="/seller/create"
                ...
                <div class="form-group" ng-if="!haveUser">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    ...
                    <span style="color: red;"
                          ng-show="sellerForm.username.$dirty && username.usernameExist && username.suggestedUsername.length > 0">Eseye <b> {{username.suggestedUsername[0]}}</b> oubyen <b>{{username.suggestedUsername[1]}}</b></span>
                  </div>
                </div>
                ...
                <div class="form-group" ng-if="!haveUser">
                  <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="confirmPassword">Konfime
                    Modpas</label>
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input type="password"
                           class="form-control round-input"
                ...
                <div class="form-group" ng-if="!useMonthlyPayment">
                  <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12"
                         for="percentageCharged">Pousantaj</label>
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 input-group">
                    <input type="number" class="form-control round-input" min="0" max="100" name="percentageCharged"
                           id="percentageCharged" required>
                    <span class="input-group-addon">%</span>
                  </div>
                </div>

                <div class="form-group" ng-if="useMonthlyPayment">
                  <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="amountCharged">Peman chak
                    mwa</label>
                  <div class="col-lg-10 col-md-10 col-sm-10 input-group">
                    <input type="number" class="form-control round-input" min="0" name="amountCharged"
                           id="amountCharged" required>
