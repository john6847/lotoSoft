        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <form name="userForm" id="userForm" class="form-horizontal form-validate" action="/user/create"
                      ...
                      <#if isSuperAdmin == true >
                        ...
                        <div class="form-group">
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12"
                                 for="enterprise">Antrepriz</label>
                ...
                <div class="form-group">
                    <#if isSuperAdmin?? >
                        <#if isSuperAdmin == true>
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="name">Kliyan<span
                                    class="required">*</span></label>
                        <#else>
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="name">Non<span
                                    class="required">*</span></label>
                        </#if>
                    </#if>
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input type="text" class="form-control round-input" placeholder="Egzanp: John Doe" id="name"
                           name="name" minlength="2" maxlength="100" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    ...
                    <span style="color: red;"
                          ng-show="userForm.username.$dirty && usernameExist && suggestedUsername.length > 0">Eseye <b> {{suggestedUsername[0]}}</b> oubyen <b>{{suggestedUsername[1]}}</b></span>
                  </div>
                </div>
