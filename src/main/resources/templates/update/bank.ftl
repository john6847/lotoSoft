...
<section id="container" class="" ng-controller="bankController">
    ...
    <section id="main-content" ng-init="init(false)">
        <section class="wrapper">
            ...
            <div class="row">
                <form class="form-horizontal form-validate" id="bankForm" name="bankForm" action="/bank/update" th:object="${bank}"
                      method="post">
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12"
                                                        ...
                                                        <#list sellers as seller>
                                                            <#if seller.id == bank.seller.id>
                                                                <option value="${seller.id}"
                                                                        selected>${seller.user.name}</option>
                                                            <#else>
                                        ...
                                        <div class="form-group" ng-if="pos.length > 0">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                <select class="form-control round-input"
                                                        ...
                                                        data-size="5"
                                                        required>
                                                    <option ng-repeat="p in pos track by p.id" value="{{p.id}}">
                                                        {{p.description}}
                                                    </option>
