...
<#include "../nav.ftl" >
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-edit"></i> Fòm pou Aktyalize Machin</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="/home">Paj Akèy</a></li>
                        <li><i class="fa fa-edit"></i>Aktyalize Machin</li>
                    </ol>
                </div>
            </div>
            <#if error??>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal form-validate" id="posForm" action="/pos/update" th:object="${pos}"
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="description">Deskripsyon<span
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-2 control-label col-xs-12" for="serial">Serial <span
                                            class="required">*</span></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
